...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BTPrinterDemo.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BTPrinterDemo.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BTPrinterDemo.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(BTPrinterDemo.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BTPrinterDemo.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
